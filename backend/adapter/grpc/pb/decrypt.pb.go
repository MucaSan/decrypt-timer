...
func (x *DecryptRequest) GetSecretKey() string {
	if x != nil {
		return x.SecretKey
	}
	return ""
...
func (x *DecryptRequest) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *DecryptResponse) GetSuccess() string {
	if x != nil {
		return x.Success
	}
	return ""
...
func (x *DecryptResponse) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_decrypt_proto_rawDesc = []byte{
	...
	0x0f, 0x64, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x22, 0x66, 0x0a, 0x0e, 0x44, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x59, 0x0a, 0x0f, 0x44, 0x65, 0x63, 0x72,
	0x79, 0x70, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73,
	...
	0x61, 0x74, 0x61, 0x32, 0x62, 0x0a, 0x0e, 0x44, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x50, 0x0a, 0x0b, 0x44, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x44, 0x61, 0x74, 0x61, 0x12, 0x1f, 0x2e, 0x64, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x5f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x44, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x64, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x5f,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x44, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x3b, 0x67, 0x72, 0x70,
...
var file_decrypt_proto_goTypes = []any{
	(*DecryptRequest)(nil),  // 0: decrypt_service.DecryptRequest
	(*DecryptResponse)(nil), // 1: decrypt_service.DecryptResponse
}
var file_decrypt_proto_depIdxs = []int32{
	0, // 0: decrypt_service.DecryptService.DecryptData:input_type -> decrypt_service.DecryptRequest
	1, // 1: decrypt_service.DecryptService.DecryptData:output_type -> decrypt_service.DecryptResponse
